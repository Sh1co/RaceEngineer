...
2. Invoke the "Generate Unit Test" command using one of the following options:
   1. Run the `RaceEngineer: Generate Unit Test 💬` command from the command palette.
   1. Select the `RaceEngineer > Generate Unit Test 💬` entry in the editor context menu (right-click).
